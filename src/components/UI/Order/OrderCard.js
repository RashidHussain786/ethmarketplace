                      ...
                      <div className="max-w-7xl mx-auto py-3 px-3 sm:px-3 lg:px-3">
                        <div className="flex items-center justify-between flex-wrap">
                          ...
                          <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                            <button type="button" className="-mr-1 flex p-2 rounded-md hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
                    ...
                    <div className="mt-2">
                      <div className="mt-1 relative rounded-md w-72">
                        <input
                          ...
                          name="price"
                          id="price"
                          className="focus:ring-cyan-500 shadow-md focus:border-cyan-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md" placeholder="x@y.com" />
                        <div className="absolute inset-y-0 right-0 flex items-center">
                          <label htmlFor="currency" className="sr-only">Currency</label>
                          <div className="flex lg:justify-start">
                            <div className="rounded-md shadow">
                              <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-sm rounded-md text-white bg-cyan-600 hover:bg-cyan-700 md:py-4 md:px-10">
                                Search
                              </a>
                            </div>
                          </div>
